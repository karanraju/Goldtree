  ...
  return (
    <div className="group cursor-pointer">
      <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
        ...
        <div
          className={`h-48 bg-gradient-to-r ${post.gradient} p-6 relative overflow-hidden`} 
        >
          {/* <div className={`absolute inset-0 ${post.gradient} opacity-80`}></div> */}
          <div className="relative z-10">
            <h3 className="text-white font-bold text-lg leading-tight mb-4 group-hover:scale-105 transition-transform duration-300">
              {post.title}
            </h3>
          </div>
          {/* Decorative elements */}
        ...
        <div className="p-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center group-hover:bg-blue-200 transition-colors duration-300">
              <span className="text-blue-600 text-xs"><ArrowRight/></span>
            </div>
          </div>
        </div>
      </div>
